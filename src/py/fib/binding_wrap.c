...
SWIGINTERN PyObject *_wrap_hs_fib(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "hs_fib" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  result = (int)hs_fib(arg1);
...
SWIGINTERN PyObject *_wrap_hs_rts_init(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  
  if (!SWIG_Python_UnpackTuple(args, "hs_rts_init", 0, 0, 0)) SWIG_fail;
  hs_rts_init();
...
SWIGINTERN PyObject *_wrap_hs_rts_exit(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  
  if (!SWIG_Python_UnpackTuple(args, "hs_rts_exit", 0, 0, 0)) SWIG_fail;
  hs_rts_exit();
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "hs_rts_init", _wrap_hs_rts_init, METH_NOARGS, NULL},
	 { "hs_rts_exit", _wrap_hs_rts_exit, METH_NOARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
